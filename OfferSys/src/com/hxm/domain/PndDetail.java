...
public class PndDetail implements Serializable{
	private int id;
	...
	public PndDetail(int id, String imageId, String productType, String model,
			String os, String cpu, String lcd, String tp, String ram,
			String rom, String dvr, String frontCamera, String realCamera,
			String card, String multimedia, String tools, String gps,
			String bluetooth, String wifi, String avin, String fmt, String tv,
	...
	public String toString() {
		return "PndDetail [id=" + id + ", imageId=" + imageId
				...
				+ ", tv=" + tv + ", band=" + band + ", gsensor=" + gsensor
