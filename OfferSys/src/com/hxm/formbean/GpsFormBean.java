...
public class GpsFormBean implements Serializable {
	...
	public GpsFormBean(String imageId, String productType, String model,
	...
	public String toString() {
		return "GpsFormBean [imageId=" + imageId + ", productType="
				+ productType + ", model=" + model + ", os=" + os + ", cpu="
				+ cpu + ", lcd=" + lcd + ", tp=" + tp + ", ram=" + ram
				+ ", rom=" + rom + ", dvr=" + dvr + ", camera=" + camera
				+ ", card=" + card + ", multimedia=" + multimedia + ", tools="
				+ tools + ", bluetooth=" + bluetooth + ", fmt=" + fmt
				+ ", avin=" + avin + ", tv=" + tv + ", speaker=" + speaker
				+ ", mic=" + mic + ", usb=" + usb + ", charger=" + charger
				+ ", battery=" + battery + ", language=" + language
