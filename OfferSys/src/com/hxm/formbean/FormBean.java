...
public class FormBean implements Serializable {
	...
	public FormBean(String imageId, String productType, String model,
	...
	public String toString() {
		return "FormBean [imageId=" + imageId + ", productType=" + productType
				+ ", model=" + model + ", cpu=" + cpu + ", lcd=" + lcd
				+ ", frontCamera=" + Arrays.toString(frontCamera)
				+ ", videoFormat=" + videoFormat + ", frameRate="
				+ Arrays.toString(frameRate) + ", photoResolution="
				+ photoResolution + ", photoFormat=" + photoFormat
				+ ", storageCard=" + storageCard + ", cardCapacity="
				+ cardCapacity + ", rearCamera=" + rearCamera + ", gsensor="
				+ gsensor + ", gps=" + gps + ", wifi=" + wifi + ", tvout="
				+ tvout + ", hdmi=" + hdmi + ", wdr=" + wdr + ", adas=" + adas
