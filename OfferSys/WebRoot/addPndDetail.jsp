...
<html>
  ...
  <body>
    <div id="content">
    		<table>
    			<tr><th colspan="2">PND Product Specificationr</th></tr>
    			<tr><td class="tit" name="imageId">ID</td><td id="img"><img id="pic" src="images/bg1.jpg" width="300"></td></tr>
    			<tr><td class="tit" name="productType">product type:</td><td contenteditable="true">PND navigation</td></tr>
    			<tr><td class="tit" name="model">MODEL:</td><td contenteditable="true">PND-7013</td></tr>
    			<tr><td class="tit" name="os">OS:</td><td contenteditable="true">Android4.4/Android 6.0</td></tr>
    			<tr><td class="tit" name="cpu">CPU:</td><td contenteditable="true">MT8127/MTK8163&nbsp; Quad Core Cortex A53 1.3GHz</td></tr>
    			<tr><td class="tit" name="lcd">LCD:</td><td contenteditable="true">7&quot;TFT HD 800X480</td></tr>
    			<tr><td class="tit" name="tp">TP:</td><td contenteditable="true">Capacitive Touch Screen ,5 points touch</td></tr>
    			<tr><td class="tit" name="ram">RAM:</td><td contenteditable="true">512M/1GB (opational)</td></tr>
    			<tr><td class="tit" name="rom">FLASH ROM:</td><td contenteditable="true">4G/8GB/16G(optional)</td></tr>
    			<tr><td class="tit" name="dvr">DVR:</td><td contenteditable="true">Build-in DVR 1080P@30fps(optional)</td></tr>
    			<tr><td class="tit" name="frontCamera">Front Camera:</td><td contenteditable="true">CMOS:2M,SENSOR GC2023/OV2710;lens:4G; D=130，H=100，V=80</td></tr>
    			<tr><td class="tit" name="realCamera">Real Camera:</td><td contenteditable="true">0.3M CVBS(optional)</td></tr>
    			...
    			<tr><td class="tit" name="gps">GPS:</td><td contenteditable="true">Built-in GPS+AGPS</td></tr>
    			<tr><td class="tit" name="bluetooth">BT:</td><td contenteditable="true">YES(optional)</td></tr>
    			<tr><td class="tit" name="wifi">WIFI:</td><td contenteditable="true">Build-in WIFI,802.11b/g/n</td></tr>
    			<tr><td class="tit" name="avin">AVIN:</td><td contenteditable="true">YES(optional)</td></tr>
    			<tr><td class="tit" name="fmt">FM transmit:</td><td contenteditable="true">YES(optional)</td></tr>
    			<tr><td class="tit" name="tv">Digital TV:</td><td contenteditable="true">Build-in Digital TV ISDB-T 1-Seg/DVB-T2(optional)</td></tr>
    			<tr><td class="tit" name="band">Band:</td><td contenteditable="true">Build-in 2G GPRS 850/900/1800/1900MHZ(optional)</td></tr>
    			<tr><td class="tit" name="speaker">Speaker:</td><td contenteditable="true">Build-in 1.5W Speaker</td></tr>
    			<tr><td class="tit" name="gsensor">G-sensor:</td><td contenteditable="true">YES(optional)</td></tr>
  ...
  <script type="text/javascript">
  	...
  	$(document).ready(function(){
  		...
  		var form = $("<form></form>");
  		//设置Form表单属性
  		form.attr({action:"${pageContext.request.contextPath}/servlet/PndControllerServlet?ctrl=add",method:"POST"});
