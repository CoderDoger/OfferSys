...
public class CreatePndExcelServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//file path
		String fileName = pndDetail.getModel()+".xls";
		String filePath = getServletContext().getRealPath("/excel/PND/"+fileName);
		
		hwb = new HSSFWorkbook();
		//create sheet
		HSSFSheet sheet = hwb.createSheet(pndDetail.getModel());
		...
		HSSFCell cell = EXCELTool.getCell(row, 0, "PND Product Specification", border);
        ...
        */  
		 ...
		 cell = EXCELTool.getCell(row, 1, pndDetail.getProductType(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 ...
		 cell = EXCELTool.getCell(row, 1, pndDetail.getModel(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 
		 //OS
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "OS", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getOs(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 
		 //CPU
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "CPU", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getCpu(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 //LCD
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "LCD", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getLcd(), border);
		 cell = EXCELTool.getCell(row, 2, "", border); 
		 //TP
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "TP", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getTp(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 //RAM
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "RAM", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getRam(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 //FLASH ROM
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "FLASH ROM", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getRom(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 //DVR
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "DVR", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getDvr(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
	
		//Front Camera
		 String frontCamera = pndDetail.getFrontCamera();
		...
		//Real Camera
		 String realCamera = pndDetail.getRealCamera();
		 ...
		 cell = EXCELTool.getCell(row, 1, pndDetail.getCard(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 //Multimedia
		 ...
		 cell = EXCELTool.getCell(row, 1, pndDetail.getTools(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//GPS
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "GPS", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getGps(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 //BT
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "BT", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getBluetooth(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		...
		//WIFI
		 ...
		 cell = EXCELTool.getCell(row, 1, pndDetail.getWifi(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//FM transmit
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "FM transmit", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getFmt(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 //AV IN
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "AV IN", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getAvin(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 //Digital TV
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "Digital TV", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getTv(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		...
		//Band
		 ...
		 cell = EXCELTool.getCell(row, 1, pndDetail.getGsensor(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		 //Speaker
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "Speaker", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getSpeaker(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//MIC
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "MIC", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getMic(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//USB
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "USB", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getUsb(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//Charger
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "Charger", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getCharger(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//Battery
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "Battery", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getBattery(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//Language
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "Language", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getLanguage(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//Operating Temperature
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "Operating Temperature", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getOperatingTemperature(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//Storage Temperature
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "Storage Temperature", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getStorageTemperature(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//Weight
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "Weight", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getWeight(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
		//Dimension
		 row = sheet.createRow(sheet.getLastRowNum()+1);
		 cell = EXCELTool.getCell(row, 0, "Dimension", border);
		 cell = EXCELTool.getCell(row, 1, pndDetail.getDimension(), border);
		 cell = EXCELTool.getCell(row, 2, "", border);
	  
		//插入ID图
		 String imgRealPath = getServletContext().getRealPath("/uploadFile/")+pndDetail.getImageId();
