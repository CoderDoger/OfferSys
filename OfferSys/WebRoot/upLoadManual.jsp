    ...
    <div id="content">
	  <div class="upload">
			...
			<form id="f1" method="post" type="ap" >
				...
				<p>
					<label>产品名称：</label> <input type="text" name="productName" />
				</p>
				<p>
  	...
  	$(document).ready(function(){
		...
		//给Form填充数据 
  		$("#confrim").click(function(){
			var flag = true;
  			var fm = $("#f1").attr({action:"${pageContext.request.contextPath}/servlet/ManualUplaodServlet?type=manual",method:"POST",enctype:"multipart/form-data"});
