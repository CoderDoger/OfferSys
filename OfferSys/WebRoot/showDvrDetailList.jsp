			...
			<table class="tab_head">
				<thead>
					<tr>
						...
						<th style="width:12%;">FrontCamera</th>
						<th style="width:10%;">RearCamera</th>
						<th style="width:5%;">Wifi</th>
						<th style="width:5%;">GPS</th>
						<th style="width:5%;">Adas</th>
						<th style="width:5%;">Wdr</th>
			...
			<div class="tabContent">
				<table class="tab_body">
        			<tbody>
						...
						<tr>
							<td style="width:4%;" class="td_sel" idv="${dvrDetail.id}" >
								<i></i>
							</td>
							<td style="width:2%;">${status.count}</td>
							<td style="width:8%;">${dvrDetail.model }</td>
							<td style="width:8%;">${dvrDetail.cpu }</td>
							<td style="width:10%;">${dvrDetail.lcd }</td>
							<!--  
							<td style="width:12%;">${dvrDetail.frontCamera }</td> 
							-->
							...
							<td  style="width:10%;">${dvrDetail.rearCamera }</td>
							<!-- 取 rearCamera 值 
							...
							<td style="width:5%;">${dvrDetail.wifi }</td>
							<td style="width:5%;">${dvrDetail.gps }</td>
							<td  style="width:5%;">${dvrDetail.adas }</td>
							<td  style="width:5%;">${dvrDetail.wdr }</td>
							<td  style="width:10%">${dvrDetail.batter }</td>
