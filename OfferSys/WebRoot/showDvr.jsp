	...
	<style type="text/css">
		*{padding:0px;margin:0px;font-size:12px;font-family: "微软雅黑";}
		...
		/********************tool start ************************************/
		 ...
		 .table .tool ul{width:78%;list-style: none;overflow: hidden;float: left;}
		 .table .tool ul li{float: left; margin: 10px 10px 0px 0px;background: #999;border-radius: 2px;}
		 .table .tool ul li:hover{background: #28b779;}
		 .table .tool ul li.tool_navi_sel{background: #28b779;}
		 .table .tool ul li a{text-decoration: none;display: block;padding: 8px 20px;color: #fff;font-size: 0px;}
		 .table .tool ul li a i{display: inline-block;width: 15px;height: 14px;vertical-align: middle;margin-right: 10px;background: url("${pageContext.request.contextPath}/images/ht_icon.png") no-repeat center;}
	
		 .table .tool ul li a i.tool_icon1{background-position:-33px -52px;}
		 .table .tool ul li a i.tool_icon2{background-position:-50px -52px;}
		 .table .tool ul li a i.tool_icon3{background-position: -67px -52px;}
		 .table .tool ul li a i.tool_icon4{background-position:-87px -52px;}
		 .table .tool ul li a i.tool_icon5{background-position:-105px -52px;}
		 .table .tool ul li a i.tool_icon6{background-position:-123px -52px}
		 .table .tool ul li a i.tool_icon7{background-position:-140px -52px;}
		 .table .tool ul li a i.tool_icon8{background-position:-155px -52px;}
		 .table .tool ul li a i.tool_icon9{background-position:-172px -52px;}
		 .table .tool ul li a i.tool_icon10{background-position:-191px -52px;}
		 .table .tool ul li a i.tool_icon11{background-position:-212px -52px;}
		 .table .tool ul li a span{vertical-align: middle;}
		/********************tool end ************************************/

		/********************search start ************************************/
		 .table .search{font-size: 0px;width: 19%;height:22px;float: right;margin: 20px 0px;}
		...
		.tab_list tr td{border: solid 1px #ddd;text-align: center;white-space:nowrap;word-break:keep-all;line-height: 40px;padding:0px 5px;}
		...
		/***************************pagelist start******************************************/
		.pagelist ul{list-style: none;float:right;overflow: hidden;}
		.pagelist ul li{line-height:30px; float:left;margin:20px;}
		.pagelist ul li span{font-weight: bold; color: #169662;}
		.pagelist ul li a{display:inline-block;line-height: 30px;width:70px;text-decoration: none;color: #fff;background:#169662;text-align:center; border-radius:5px;}
		/***************************pagelist end******************************************/
...
<!-- ************************************************end********************************************************************* -->		
	...
	<div class="pagelist">
		<ul>
			...
			<li><a href="${pageContext.request.contextPath}?currentPageNum=${page.proviousPageNum}">上一页 </a></li>
			<li><a href="${pageContext.request.contextPath}?currentPageNum=${page.nextPageNum}">下一页</a></li>
			<li><a href="${pageContext.request.contextPath}?currentPageNum=${page.endPage}">尾面</a> 	</li>
		</ul>
	    <!-- 
	    <p class="pagelist">
